...
<div class="mobileTop">
  ...
  <select class="mobileNavSelect" onchange="if(this.value) location.href=this.value">
    ...
    <option value="/dashboard/ask-goliath.php">Ask Goliath Live</option>
    <option value="/dashboard/scorsese-media-center.php">Scorsese Media Center</option>
    <option value="/dashboard/goliath-social.php">Goliath Social</option>
...
<aside class="side">
  ...
  <nav class="nav">
    ...
    <a class="<?=gactive33('ask-goliath.php')?>" href="/dashboard/ask-goliath.php">Ask Goliath Live</a>
    ...
    <a class="<?=gactive33('goliath-social.php')?>" href="/dashboard/goliath-social.php">Goliath Social</a>
  </nav>
</aside>