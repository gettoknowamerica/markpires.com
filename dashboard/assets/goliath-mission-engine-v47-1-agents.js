(function(){
  window.__GOLIATH_MOVEMENT_ENGINE_VERSION='47.1-ten-agent-live';
  const defs={
  ...
  const labels={Jessica:'emailing leads',Scout:'finding contacts',Scorsese:'editing media',Mozart:'shaping songs',Shakespeare:'writing content',Einstein:'reading signals',Columbo:'finding gold',Prospector:'mining deals',Rockefeller:'ranking ROI',Pandora:'expanding empire'};
