...
<title>Scout Workbench OS</title>
<style>
...
<body>
<div class="topbar">
 <div class="topline"><div><h1>🕵️ Scout Workbench</h1><div class="small">Speed-to-lead command center. Phones/emails and newest files always rise to the top.</div></div></div>
 <div class="actions">
